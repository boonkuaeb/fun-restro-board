package com.bk.funrestroboard.controller;

import com.bk.funrestroboard.model.Comment;
import com.bk.funrestroboard.model.CommentType;
import com.bk.funrestroboard.service.CommentService;
...
public class CommentControllerTest {
    ...
    public void saveComments_HappyPath_ShouldReturnStatus302() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(post("/comment")
                .with(csrf())
                .with(user("boonkuaeb").roles("USER"))
                .param("plusComment", "Test Plus")); // Then
